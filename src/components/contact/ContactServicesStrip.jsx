...
const services = [
    {
        ...
        description:
            "Premium websites built to elevate your brand presence and conversions.",
    },

    {
        ...
        description:
            "Strategic visuals and modern branding systems that feel memorable.",
    },

    {
        ...
        description:
            "Scalable and high-performance digital products for modern businesses.",
    },

    {
        ...
        description:
            "Performance-focused solutions designed to help your business scale faster.",
    },
];
        ...
        ========================================================= */}
                ...
                >
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-white/55">
                        From premium websites to scalable digital
                        experiences, we create systems that look sharp,
                        perform fast, and help businesses grow online.
                    </p>
                </motion.div>
