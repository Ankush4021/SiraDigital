    ...
    return (
        <section className="relative overflow-hidden pt-36 pb-24">
            ...
            <div className="mx-auto flex max-w-7xl flex-col items-center px-6 text-center">
                ...
                >
                    We partner with ambitious businesses to create
                    premium websites, scalable digital products, and
                    modern brand experiences that actually stand out.
                </motion.p>
                ...
                >
                    {[
                        ...
                        >
                            ...
                            <span className="text-sm tracking-wide text-white/45">
                                {item}
                            </span>
                        </div>
                    ))}
                ...
                >
                    ...
                    <span className="mt-2 text-xs uppercase tracking-[0.2em] text-white/30">
                        Scroll
                    </span>
                </motion.div>
            </div>
