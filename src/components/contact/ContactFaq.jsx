        ...
        ========================================================= */}
                ...
                >
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-white/55">
                        ...
                        your project with SIRA Digital.
                    </p>
                </motion.div>
                    ...
                    {faqs.map((faq, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    className={`absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#a64dff] to-transparent transition-opacity duration-500 ${isActive ? "opacity-100" : "opacity-0"
                                        }`}
                                />
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="max-w-2xl">
                            ...
                            <p className="mt-4 text-lg leading-8 text-white/55">
                                Ask us directly and we’ll help you understand the
                                best solution for your project, timeline, or goals.
                            </p>
                        </div>
