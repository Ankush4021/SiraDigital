            ...
            <div className="relative z-[1] grid gap-20 lg:grid-cols-[0.8fr_1.2fr]">
                ...
                >
                    ...
                    <p className="relative z-10 mt-8 max-w-xl text-[1rem] leading-8 text-white/60">
                        SIRA Digital creates clean visual systems for businesses that
                        want stronger branding, modern websites, and more consistent
                        digital experiences without unnecessary complexity.
                    </p>
                ...
                >
                    ...
                    >
                        ...
                        <p className="mt-6 text-[0.98rem] leading-8 text-white/55">
                            Focused on creating digital experiences that feel cleaner,
